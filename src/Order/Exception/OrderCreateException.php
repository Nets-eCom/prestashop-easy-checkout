...
{
    public function __construct(private readonly string $paymentId, int $code = 0, $previous = null)
    {
        ...
        parent::__construct(\sprintf("Couldn't create order for payment with id: %s", $paymentId), $code, $previous);
    }
